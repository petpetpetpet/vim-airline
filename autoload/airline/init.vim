...
function! airline#init#bootstrap()
  ...
  call airline#parts#define_empty(['hunks', 'branch', 'obsession', 'tagbar',
        \ 'syntastic-warn', 'syntastic-err', 'syntastic-style-err',
        \ 'syntastic-style-warn', 'syntastic-pure-err', 'eclim', 'whitespace',
        \ 'windowswap', 'ycm_error_count', 'ycm_warning_count',
        \ 'neomake_error_count', 'neomake_warning_count', 'ale_error_count',
        \ 'ale_warning_count', 'languageclient_error_count',
...
function! airline#init#sections()
  ...
  if !exists('g:airline_section_error')
    let g:airline_section_error = airline#section#create(['ycm_error_count',
        \ 'syntastic-err', 'syntastic-style-err', 'syntastic-pure-err',
        \ 'eclim', 'neomake_error_count', 'ale_error_count',
        \ 'languageclient_error_count'])
  endif
  if !exists('g:airline_section_warning')
    let g:airline_section_warning = airline#section#create([
        \ 'ycm_warning_count', 'syntastic-warn', 'syntastic-style-warn',
        \ 'neomake_warning_count', 'ale_warning_count',
